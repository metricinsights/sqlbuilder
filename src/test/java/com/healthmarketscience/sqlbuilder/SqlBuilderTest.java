...
import static com.healthmarketscience.sqlbuilder.Conditions.between;
import static com.healthmarketscience.sqlbuilder.Conditions.emptyCond;
import static com.healthmarketscience.sqlbuilder.Conditions.equalTo;
import static com.healthmarketscience.sqlbuilder.Conditions.exists;
import static com.healthmarketscience.sqlbuilder.Conditions.greaterThan;
...
import static com.healthmarketscience.sqlbuilder.Conditions.notLike;
import static com.healthmarketscience.sqlbuilder.Conditions.or;
import static com.healthmarketscience.sqlbuilder.Expressions.add;
import static com.healthmarketscience.sqlbuilder.Expressions.caseStmt;
import static com.healthmarketscience.sqlbuilder.Expressions.concatenate;
import static com.healthmarketscience.sqlbuilder.Expressions.customSql;
import static com.healthmarketscience.sqlbuilder.Expressions.multiply;
import static com.healthmarketscience.sqlbuilder.Expressions.negate;
import static com.healthmarketscience.sqlbuilder.Expressions.subquery;
import static com.healthmarketscience.sqlbuilder.Expressions.subtract;
...
public class SqlBuilderTest extends BaseSqlTestCase {
    ...
    public void testSelect() {
        {
            ...
            String selectStr7 = selectQuery1.addHaving(greaterThan(_defTable1_col2, new NumberValueObject(1), false))
                    .toString();
    ...
    public void testExpression() {
        ...
        String exprQuery = new SelectQuery()
                ...
                .validate().toString();
        checkResult(exprQuery,
                    "SELECT (37 + t2.col5 + (- (t0.col1 * 4.7)) + 'PI' + (8 - 3)),t0.col2 FROM Table2 t2,Schema1.Table1 t0");
    ...
    public void testSubquery() {
                ...
                new SelectQuery()
                        ...
                        .addCondition(new InCondition(
                                ...
                                new SelectQuery()
                                        ...
                                        .validate())))
                        .validate().toString();
        checkResult(queryStr1,
                    "SELECT t0.col1,t0.col2 FROM Schema1.Table1 t0 WHERE (t0.col1 IN (SELECT t1.col3 FROM Table1 t1) )");
        ...
        checkResult(queryStr3,
                    "SELECT t0.col1,t0.col2 FROM Schema1.Table1 t0 INNER JOIN Table1 t1 ON (t0.col1 = t1.col_id) WHERE (t0.col1 IN (SELECT t2.col4 FROM Table2 t2 WHERE (t0.col1 = t2.col_id)) )");
        ...
        checkResult(queryStr4,
                    "SELECT t2.col4 FROM Schema1.Table1 t0 INNER JOIN Table2 t2 ON (t0.col1 = t2.col_id) WHERE (t0.col1 = t1.col_id)");
        ...
        checkResult(queryStr5,
                    "SELECT t0.col1,t0.col2 FROM Schema1.Table1 t0 INNER JOIN Table1 t1 ON (t0.col1 = t1.col_id) WHERE (t0.col1 IN (SELECT t2.col4 FROM Schema1.Table1 t0 INNER JOIN Table2 t2 ON (t0.col1 = t2.col_id) WHERE (t0.col1 = t1.col_id)) )");
    }
    ...
    public void testValidationException() {
        ...
        checkResult(msg,
                    "Columns used for unreferenced tables [Table1(t1)] [Failed clause: SELECT t1.col_id FROM Schema1.Table1 t0]");
        ...
        assertTrue(msg.matches(
                "Columns used for unreferenced tables \\[Table1\\(t1\\)\\] \\[Verifiable: com.healthmarketscience.sqlbuilder.SelectQuery@[0-9a-f]+\\]"));
    ...
    public void testCrossSchemaFK() throws Exception {
        ...
        checkResult(createStr,
                    "CREATE TABLE DefTable3 (col_id NUMBER CONSTRAINT t2_id_fk REFERENCES Schema1.Table1 (col2))");
    }
    ...
    public void testWindowFunctions() {
        ...
        checkResult(exprStr,
                    "AVG() OVER (PARTITION BY t1.col_id ORDER BY t1.col2 ROWS BETWEEN UNBOUNDED PRECEDING AND 5 FOLLOWING)");
        ...
        checkResult(queryStr,
                    "SELECT t0.col1,t0.col2,AVG() OVER w AS average FROM Schema1.Table1 t0,Table1 t1 WINDOW w AS (PARTITION BY t1.col_id ORDER BY t1.col2 ROWS BETWEEN UNBOUNDED PRECEDING AND 5 FOLLOWING EXCLUDE CURRENT ROW)");
    }
}
